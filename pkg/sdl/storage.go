...
type StorageInterface struct {
	...
	Ready func(userdata uintptr) bool

	/* Enumerate a directory, optional for write-only storage */
	Enumerate func(userdata uintptr, path string, callback EnumerateDirectoryCallback, callback_userdata uintptr) bool

	/* Get path information, optional for write-only storage */
	Info func(userdata uintptr, path string, info *PathInfo) bool

	/* Read a file from storage, optional for write-only storage */
	ReadFile func(userdata uintptr, path string, destination *byte, length uint64) bool

	/* Write a file to storage, optional for read-only storage */
	WriteFile func(userdata uintptr, path string, source *byte, length uint64) bool

	/* Create a directory, optional for read-only storage */
	MkDir func(userdata uintptr, path string) bool

	/* Remove a file or empty directory, optional for read-only storage */
	Remove func(userdata uintptr, path string) bool

	/* Rename a path, optional for read-only storage */
	Rename func(userdata uintptr, oldpath, newpath string) bool

	/* Copy a file, optional for read-only storage */
	Copy func(userdata uintptr, oldpath, newpath string) bool

	/* Get the space remaining, optional for read-only storage */
	SpaceRemaining func(userdata uintptr) uint64
}
 ...
 */
//go:sdl3extern
var OpenTitleStorage func(override string, props PropertiesID) Storage
 ...
 */
//go:sdl3extern
var OpenUserStorage func(org, app string, props PropertiesID) Storage
 ...
 */
//go:sdl3extern
var OpenFileStorage func(path string) Storage
 ...
 */
//go:sdl3extern
var OpenStorage func(iface *StorageInterface, userdata uintptr) Storage
 ...
 */
//go:sdl3extern
var CloseStorage func(storage Storage) bool
 ...
 */
//go:sdl3extern
var StorageReady func(storage Storage) bool
 ...
 * \sa SDL_StorageReady
 */
var GetStorageFileSize func(storage Storage, path string, length *uint64) bool
 ...
 */
//go:sdl3extern
var ReadStorageFile func(storage Storage, path string, destination *byte, length uint64) bool
 ...
 */
//go:sdl3extern
var WriteStorageFile func(storage Storage, path, source string, length uint64) bool
 ...
 */
//go:sdl3extern
var CreateStorageDirectory func(storage Storage, path string) bool
 ...
 */
//go:sdl3extern
var EnumerateStorageDirectory func(storage Storage, path string, callback EnumerateDirectoryCallback, userdata uintptr) bool
 ...
 */
//go:sdl3extern
var RemoveStoragePath func(storage Storage, path string) bool
 ...
 */
//go:sdl3extern
var RenameStoragePath func(storage Storage, oldpath, newpath string) bool
 ...
 */
//go:sdl3extern
var CopyStorageFile func(storage Storage, oldpath, newpath string) bool
 ...
 */
//go:sdl3extern
var GetStoragePathInfo func(storage Storage, path string, info *PathInfo) bool
 ...
 */
//go:sdl3extern
var GetStorageSpaceRemaining func(storage Storage) uint64
 ...
 */
//go:sdl3extern
var GlobStorageDirectory func(storage Storage, path string, pattern string, flags GlobFlags, count *int32) *string
