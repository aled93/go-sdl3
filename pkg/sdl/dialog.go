 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
type DialogFileCallback func(userdata uintptr, filelist **byte, filter int32)
 ...
 */
//go:sdl3extern
var ShowFileDialogWithProperties func(type_ FileDialogType, callback DialogFileCallback, userdata uintptr, props PropertiesID)

const (
	PROP_FILE_DIALOG_FILTERS_POINTER PropertyName = "SDL.filedialog.filters"
	PROP_FILE_DIALOG_NFILTERS_NUMBER PropertyName = "SDL.filedialog.nfilters"
	PROP_FILE_DIALOG_WINDOW_POINTER  PropertyName = "SDL.filedialog.window"
	PROP_FILE_DIALOG_LOCATION_STRING PropertyName = "SDL.filedialog.location"
	PROP_FILE_DIALOG_MANY_BOOLEAN    PropertyName = "SDL.filedialog.many"
	PROP_FILE_DIALOG_TITLE_STRING    PropertyName = "SDL.filedialog.title"
	PROP_FILE_DIALOG_ACCEPT_STRING   PropertyName = "SDL.filedialog.accept"
	PROP_FILE_DIALOG_CANCEL_STRING   PropertyName = "SDL.filedialog.cancel"
)
